...
static void test_fanotify(void)
{
	...
	/*
	 * drop_caches should evict inode from cache and remove volatile mark
	 */
	SAFE_FILE_PRINTF("/proc/sys/vm/drop_caches", "2");

	/*
	 * We know that inode with volatile mark was evicted when a
	...
	/* Read events to verify ACCESS was properly generated */
...
static struct tst_test test = {
	...
	.needs_root = 1,
	.mount_device = 1,
	/* Something is odd with drop_caches on ext2/4 */
	.dev_fs_type = "xfs",
	.mntpoint = MOUNT_PATH,
};
