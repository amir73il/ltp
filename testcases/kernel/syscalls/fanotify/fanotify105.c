...
{
	SAFE_MKDIR(MOUNT_PATH"/"DIR_NAME, 0755);
	strcpy(fname1, MOUNT_PATH"/"DIR_NAME"/"FILE_NAME1);
	strcpy(fname2, MOUNT_PATH"/"DIR_NAME"/"FILE_NAME2);
	...
	if (fanotify_mark(fd_notify, FAN_MARK_ADD | FAN_MARK_FILESYSTEM,
